...
**Multi-omic OncoMetabolismGPS** is an interactive Shiny application developed as part of the research associated with the paper **A Pan-Cancer Atlas of Metabolic Regulatory Circuitries Integrating Multi-Omic, Immune, and Clinical Dimensions**, available at **[Frontiers in Molecular Biosciences](https://doi.org/10.3389/fmolb.2026.1845099).**
...
If you use the **OncoMetabolismGPS Shiny** App or the results generated by this application, please cite our paper:

Almeida Cordeiro Nogueira H., Rodrigues de Souza E., dos Santos Lopes V. and Medina-Acosta E. (2026). A pan-cancer atlas of metabolic regulatory circuitries integrating multi-omic, immune, and clinical dimensions. Frontiers in Molecular Biosciences 13:1-20, available at **[Frontiers in Molecular Biosciences](https://doi.org/10.3389/fmolb.2026.1845099).**
