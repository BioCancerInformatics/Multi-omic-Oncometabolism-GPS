...
setwd("E:/Oncometabolism_GPS/19- Tumor_immune_and_microenvironment_signature_classification/Gene/mRNA/")

# Carregar os dados
data <- import("/Oncometabolism_GPS/18- Tumor_cell_infiltration_signature_analysis/Gene/mRNA/TIL_filtered_results_v1.tsv")
