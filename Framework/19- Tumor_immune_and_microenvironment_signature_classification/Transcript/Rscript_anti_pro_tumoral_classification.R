...
setwd("E:/Oncometabolism_GPS/19- Tumor_immune_and_microenvironment_signature_classification/Transcript/")

df1 <- import("/Oncometabolism_GPS/18- Tumor_cell_infiltration_signature_analysis/Transcript/TIL_filtered_results_v1_01.tsv")
df2 <- import("/Oncometabolism_GPS/18- Tumor_cell_infiltration_signature_analysis/Transcript/TIL_filtered_results_v1_02.tsv")
df4 <- import("/Oncometabolism_GPS/18- Tumor_cell_infiltration_signature_analysis/Transcript/TIL_filtered_results_v1_04.tsv")
df5 <- import("/Oncometabolism_GPS/18- Tumor_cell_infiltration_signature_analysis/Transcript/TIL_filtered_results_v1_05.tsv")
df3 <- import("/Oncometabolism_GPS/18- Tumor_cell_infiltration_signature_analysis/Transcript/TIL_filtered_results_v1_03.tsv")

# Carregar os dados
data <- rbind(df1, df2, df4, df5, df3)
