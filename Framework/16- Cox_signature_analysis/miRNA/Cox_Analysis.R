...
# Diretório
setwd("E:/Higor/Cancer_metabolism_project/16- Cox_signature_analysis/miRNA/")
...
# Filter the genes to include only rows where genotypic is "mRNA"
genes <- genes %>% filter(Genotypic_var == "miRNA expression")
