...
# Diretório
setwd("E:/Higor/Cancer_metabolism_project/16- Cox_signature_analysis/Transcript")
...
# Dataframe
genes <- import("/Higor/Cancer_metabolism_project/15- FIltering_signature_results/Transcript_signatures/All_correlation_signature_results.tsv")
