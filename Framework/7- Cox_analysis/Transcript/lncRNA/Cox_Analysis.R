...
# Diretório
setwd("F:/Higor/Cancer_metabolism_analysis_06/7- Cox_Analysis/Transcript/lncRNA/")
...
# Dataframe
genes <- import("/Higor/Cancer_metabolism_analysis_06/6- Merge all correlation results/Transcript/lncRNA/All_results_transcript.tsv")
