...
# Diretório
setwd("F:/Higor/Cancer_metabolism_analysis_06/7- Cox_Analysis/miRNA/")
...
# Dataframe
genes <- import("/Higor/Cancer_metabolism_analysis_06/6- Merge all correlation results/miRNA/All_results_miRNA.tsv")
