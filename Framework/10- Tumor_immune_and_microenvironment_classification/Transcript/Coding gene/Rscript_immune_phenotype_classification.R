...
setwd("E:/Higor/Cancer_metabolism_project/10- Tumor_immune_and_microenvironment_classification/Transcript/Coding gene/")

# Importar dados
data <- import("/Higor/Cancer_metabolism_project/10- Tumor_immune_and_microenvironment_classification/Transcript/Coding gene/Microenvironment_classification.tsv")
