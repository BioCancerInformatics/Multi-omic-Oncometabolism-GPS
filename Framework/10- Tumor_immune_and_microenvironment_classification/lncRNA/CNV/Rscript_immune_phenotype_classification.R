...
setwd("E:/Higor/Cancer_metabolism_project/10- Tumor_immune_and_microenvironment_classification/lncRNA/CNV/")

# Importar dados
data <- import("/Higor/Cancer_metabolism_project/10- Tumor_immune_and_microenvironment_classification/lncRNA/CNV/Microenvironment_classification.tsv")
