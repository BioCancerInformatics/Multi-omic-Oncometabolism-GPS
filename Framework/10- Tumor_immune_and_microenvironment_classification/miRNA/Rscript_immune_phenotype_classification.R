...
setwd("E:/Higor/Cancer_metabolism_project/10- Tumor_immune_and_microenvironment_classification/miRNA/")

# Importar dados
data <- import("/Higor/Cancer_metabolism_project/10- Tumor_immune_and_microenvironment_classification/miRNA/Microenvironment_classification.tsv")
