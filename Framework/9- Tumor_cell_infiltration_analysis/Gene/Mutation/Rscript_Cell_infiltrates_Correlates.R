...
setwd("E:/Higor/Cancer_metabolism_project/9- Tumor_cell_infiltration_analysis/Gene/Mutation/")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_project/8- Survival_Analysis/Gene/Mutation/multi_metric_survival_analysis_results.tsv")
