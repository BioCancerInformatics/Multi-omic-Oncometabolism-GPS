...
setwd("F:/Higor/Cancer_metabolism_project/9- Tumor_cell_infiltration_analysis/Gene/Methylation/")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_project/8- Survival_Analysis/Gene/Methylation/Survival_analysis.tsv")
