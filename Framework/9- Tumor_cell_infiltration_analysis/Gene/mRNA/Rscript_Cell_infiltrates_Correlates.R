...
setwd("F:/Higor/Cancer_metabolism_analysis_06/9- Tumor cell infiltration_Analysis/Gene/mRNA/")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_project/8- Survival_Analysis/Gene/mRNA/Survival_analysis.tsv")
