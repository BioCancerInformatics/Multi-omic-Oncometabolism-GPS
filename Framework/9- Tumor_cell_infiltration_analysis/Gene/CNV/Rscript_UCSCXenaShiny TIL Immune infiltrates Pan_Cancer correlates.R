...
setwd("F:/Higor/Cancer_metabolism_project/9- Tumor_cell_infiltration_analysis/Gene/CNV/")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_project/8- Survival_analysis/Gene/CNV/Updated_Cox_results_with_survival_analysis.tsv")
