...
setwd("F:/Higor/Cancer_metabolism_analysis_06/9- Tumor cell infiltration_Analysis/Transcript/Coding gene/")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_analysis_06/8- Survival_Analysis/Transcript/Coding gene/Survival_analysis.tsv")
