...
setwd("F:/Higor/Cancer_metabolism_analysis_06/9- Tumor cell infiltration_Analysis/lncRNA/Mutation/")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_analysis_06/8- Survival_Analysis/lncRNA/Mutation/multi_metric_survival_analysis_results.tsv")
