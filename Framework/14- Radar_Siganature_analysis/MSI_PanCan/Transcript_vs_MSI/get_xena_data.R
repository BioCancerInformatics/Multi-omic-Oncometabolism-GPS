...
### GET_XENA_DATA - Transcript vs MSI
...
setwd("E:/Higor/Cancer_metabolism_project/14- Radar_Siganature_analysis/MSI_PanCan/Transcript_vs_MSI/")
...
genes <- tryCatch({
  readRDS("/Higor/Cancer_metabolism_project/13- Building_metabolic_signatures/Signatures_by_omic_layer/Transcript_signature.rds")
}, error = function(e) {
...
# Filter rows where Phenotypic_layer contains "Microsatellite instability"
genes <- genes[grep("Microsatellite instability", genes$Phenotypic_layer, ignore.case = TRUE), ]
