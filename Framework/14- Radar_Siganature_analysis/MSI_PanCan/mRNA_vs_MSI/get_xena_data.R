...
setwd("E:/Higor/Cancer_metabolism_project/14- Radar_Siganature_analysis/MSI_PanCan/mRNA_vs_MSI/")
...
genes <- tryCatch({
  readRDS("/Higor/Cancer_metabolism_project/13- Building_metabolic_signatures/Signatures_by_omic_layer/Gene_expression_signature.rds")
}, error = function(e) {
