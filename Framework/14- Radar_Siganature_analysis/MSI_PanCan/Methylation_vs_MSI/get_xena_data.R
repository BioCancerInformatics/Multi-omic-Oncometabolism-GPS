...
### GET_XENA_DATA - METHYLATION vs MSI
...
setwd("E:/Higor/Cancer_metabolism_project/14- Radar_Siganature_analysis/MSI_PanCan/Methylation_vs_MSI/")
...
genes <- tryCatch({
  readRDS("E:/Higor/Cancer_metabolism_project/13- Building_metabolic_signatures/Signatures_by_omic_layer/Methylation_signature.rds")
}, error = function(e) {
