...
setwd("E:/Higor/Cancer_metabolism_project/14- Radar_Siganature_analysis/Stemness_PanCan/Methylation_vs_Stemness")
...
genes <- tryCatch({
  readRDS("/Higor/Cancer_metabolism_project/13- Building_metabolic_signatures/Signatures_by_omic_layer/Methylation_signature.rds")
}, error = function(e) {
