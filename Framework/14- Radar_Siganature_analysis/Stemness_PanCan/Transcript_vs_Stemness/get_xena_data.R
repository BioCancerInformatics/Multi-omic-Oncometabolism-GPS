...
setwd("E:/Higor/Cancer_metabolism_project/14- Radar_Siganature_analysis/Stemness_PanCan/Transcript_vs_Stemness/")
...
# Filter rows where Phenotypic_layer contains "Stemness"
genes <- genes[grep("Stemness", genes$Phenotypic_layer, ignore.case = TRUE), ]
