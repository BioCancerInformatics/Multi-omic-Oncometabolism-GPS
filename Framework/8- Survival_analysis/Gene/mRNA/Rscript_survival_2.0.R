...
# Set directory
setwd("F:/Higor/Cancer_metabolism_analysis_06/8- Survival_Analysis/Gene/mRNA/")

# Import table
table <- import("F:/Higor/Cancer_metabolism_analysis_06/7- Cox_Analysis/Gene/mRNA/Cox_results.tsv")
