...
# Set directory
setwd("F:/Higor/Cancer_metabolism_analysis_06/8- Survival_Analysis/Transcript/Coding gene/")

# Import table
table <- import("F:/Higor/Cancer_metabolism_analysis_06/7- Cox_Analysis/Transcript/Coding gene/Cox_results.tsv")
table <- table[1:20000, ]
...
export(table, "Survival_analysis_1.tsv")
