...
# Set directory
setwd("F:/Higor/Cancer_metabolism_analysis_06/8- Survival_Analysis/lncRNA/Methylation/")

# Import table
table <- import("F:/Higor/Cancer_metabolism_analysis_06/7- Cox_Analysis/lncRNA/Methylation/Cox_results.tsv")
