...
setwd("E:/Higor/Cancer_metabolism_project/18- Tumor_cell_infiltration_signature_analysis/miRNA/")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_project/17- Survival_signature_analysis/miRNA/multi_metric_survival_analysis_results.tsv")
