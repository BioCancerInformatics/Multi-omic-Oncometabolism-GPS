...
setwd("E:/Higor/Cancer_metabolism_project/18- Tumor_cell_infiltration_signature_analysis/Gene/Methylation/")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_project/17- Survival_signature_analysis/Gene/Methylation/Survival_analysis.tsv")
...
export(til_results, "TIL_results.tsv")

# Exportando os resultados gerais para um arquivo
export(data, "TIL_filtered_results_v1.tsv")

# Exportando os resultados gerais para um arquivo
export(data02, "TIL_filtered_results_v2.tsv")
