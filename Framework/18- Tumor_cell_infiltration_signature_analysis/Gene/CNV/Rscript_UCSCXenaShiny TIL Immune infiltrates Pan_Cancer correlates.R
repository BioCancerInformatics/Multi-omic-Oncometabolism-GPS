...
setwd("E:/Higor/Cancer_metabolism_project/18- Tumor_cell_infiltration_signature_analysis/Gene/CNV")

# Importando o arquivo
Table <- import("/Higor/Cancer_metabolism_project/17- Survival_signature_analysis/Gene/CNV/Survival_analysis.tsv")
