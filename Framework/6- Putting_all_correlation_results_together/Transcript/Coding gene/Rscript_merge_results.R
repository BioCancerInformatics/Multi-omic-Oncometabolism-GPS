...
file_info <- list(
  list("MSI_PanCan/Transcript_vs_MSI/Coding gene/results/gene_cancer_correlation_network_0.1.tsv", "Transcript expression", "MSI"),
  list("TMB_PanCan/Transcript_vs_TMB/Coding gene/results/gene_cancer_correlation_network_0.1.tsv", "Transcript expression", "TMB"),
  list("Stemness_PanCan/Transcript_vs_Stemness/Coding gene/results/gene_cancer_correlation_network_0.1.tsv", "Transcript expression", "Stemness")
)
...
setwd("F:/Higor/Cancer_metabolism_analysis_06/6- Merge all correlation results/Transcript/Coding gene/")
