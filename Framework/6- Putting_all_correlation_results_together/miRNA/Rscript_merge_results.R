...
file_info <- list(
  list("MSI_PanCan/miRNA_vs_MSI/results/gene_cancer_correlation_network_0.1.tsv", "miRNA expression", "MSI"),
  list("Stemness_PanCan/miRNA_vs_Stemness/results/gene_cancer_correlation_network_0.1.tsv", "miRNA expression", "Stemness"),
  list("TMB_PanCan/miRNA_vs_TMB/results/gene_cancer_correlation_network_0.1.tsv", "miRNA expression", "TMB")
)
...
setwd("F:/Higor/Cancer_metabolism_analysis_06/6- Merge all correlation results/miRNA/")

export(All_results, "All_results_miRNA.tsv")
