...
# Set directory
setwd("E:/Higor/Cancer_metabolism_project/17- Survival_signature_analysis/Transcript")

# Import table
table <- import("/Higor/Cancer_metabolism_project/16- Cox_signature_analysis/Transcript/Cox_results_03.tsv")
table <- table[1:20000, ]
...
export(table, "Survival_analysis_01.tsv")
