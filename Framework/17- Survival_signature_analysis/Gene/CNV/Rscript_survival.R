...
# Set directory
setwd("E:/Higor/Cancer_metabolism_project/17- Survival_signature_analysis/Gene/CNV/")

# Import table
table <- import("E:/Higor/Cancer_metabolism_project/16- Cox_signature_analysis/Gene/CNV/Cox_results.tsv")
