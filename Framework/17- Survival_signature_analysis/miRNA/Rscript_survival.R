...
# Set directory
setwd("E:/Higor/Cancer_metabolism_project/17- Survival_signature_analysis/miRNA/")

# Import table
table <- import("E:/Higor/Cancer_metabolism_project/16- Cox_signature_analysis/miRNA/Cox_results.tsv")
